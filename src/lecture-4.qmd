...
> The **null hypothesis** is the default assumption that there is no effect or no difference. Here, the null hypothesis is that the lady cannot tell the difference between the two types of cups, and is just guessing.

The null hypothesis is unlikely given the data, so we reject it.
...
> The p-value is the probability of getting results at least as extreme as the observed results, assuming that the null hypothesis is true. 
